  ...
  examples: [
    {
      ...
      outputText: "49",
      img: example.src,
      explanation: `<p class='mt-3'>The above vertical lines are represented by array <code>[1,8,6,2,5,4,8,3,7]</code>. In this case, the max area of water (blue section) the container can contain is <strong>49</strong>.</p>`,
    },
    {
      id: 1,
